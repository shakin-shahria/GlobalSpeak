...
useEffect(() => {
  ...
  return (
    <main className='flex-1 p-4 flex flex-col justify-center gap-3 sm:gap-4 md: text-center pd-20'>
       ...
       <p className='text-base'>Or <label className='text-blue-400 curson-pointer hover:text-blue-600 duration-200'>upload
         <input onClick={(e)=>{const tempFile = e.target.files[0]
